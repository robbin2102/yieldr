    ...
    <>
      ...
      <header className="docs-header">
        ...
        <div className="header-right">
          ...
          <Link href="/team" className="header-link">Team</Link>
          <Link href="/build-in-public" className="header-link">Build Progress</Link>
          <div className="header-divider"></div>
          <Link href="https://discord.com/channels/1426305214176165941/1426305389812646091" target="_blank" className="header-icon discord" title="Discord">
          ...
          <Link href="https://github.com/robbin2102/yieldr-app" target="_blank" className="header-icon github" title="GitHub">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <button className="header-cta" onClick={() => setShowPopup(true)}>Get Early Access</button>
