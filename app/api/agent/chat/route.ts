...
• Quant Agent — analyzes wallet history: where edge exists, which markets perform best, entry/exit behavior, sizing, holding periods, drawdown history, win rate, regime sensitivity, repeatability, whether performance is edge/beta/luck/insider timing. Goal: explain WHY edge exists and whether it can scale. Self-serve test release October 2026.
...
How it works when live (October 2026 for applications, Q1 2027 for public deposits):
...
Phase 2 (around October 2026): Whitelist + fund launch applications open.
...
Phase 4 (October 2026): Quant Agent self-serve test live; vault launch applications open for traders with edge.
