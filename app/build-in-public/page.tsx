...
export default function BuildInPublicPage() {
  ...
  return (
    <>
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=JetBrains+Mono:wght@400;500;600;700&family=Manrope:wght@400;500;600;700;800&display=swap"
        rel="stylesheet"
      />
      <Universe />
      ...
      <nav className="bip-nav">
        <Link href="/" className="nav-l" style={{ textDecoration: 'none' }}>
      ...
      <main className="bip-main">
        ...
        <div className="build-cta reveal">
          ...
          <Link href="/explorer" className="btn-p">Enter Vaults — Early Access ↗</Link>
        </div>
      ...
      <footer className="bip-footer">
        ...
        <div className="f-txt">Yieldr &copy; 2026. Built on Base. <a href="https://yieldr.org">yieldr.org</a></div>
